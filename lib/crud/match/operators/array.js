...
registry.registerOperator('post', '$all', function (doc, query) {
...
registry.registerOperator('post', '$elemMatch', function (doc, query) {
...
registry.registerOperator('post', '$size', function (doc, query) {
