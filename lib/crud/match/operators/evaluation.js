...
registry.registerOperator('post', '$mod', function (doc, query) {
...
registry.registerOperator('post', '$regex', function (doc, query, options) {
...
registry.registerOperator('post', '$options', function (doc, query, options) {
