...
registry.registerOperator('post', '$geoWithin', function (doc, query) {
...
registry.registerOperator('post', '$geoIntersects', function (doc, query) {
...
registry.registerOperator('post', '$near', function (doc, operand, options, siblings) {
  return h._near(doc, operand, siblings, 'planar'); // legacy = planar; GeoJSON form handled inside
});

registry.registerOperator('post', '$nearSphere', function (doc, operand, options, siblings) {
