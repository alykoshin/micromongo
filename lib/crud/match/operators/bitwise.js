...
registry.registerOperator('post', '$bitsAllSet', function (doc, query) {
  return h._bitsMatch(doc, query, 'allSet');
});

registry.registerOperator('post', '$bitsAnySet', function (doc, query) {
  return h._bitsMatch(doc, query, 'anySet');
});

registry.registerOperator('post', '$bitsAllClear', function (doc, query) {
  return h._bitsMatch(doc, query, 'allClear');
});

registry.registerOperator('post', '$bitsAnyClear', function (doc, query) {
