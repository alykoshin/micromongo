...
registry.registerOperator('pre', '$text', function (doc, query) {
...
registry.registerOperator('pre', '$and', function (doc, query) {
...
registry.registerOperator('pre', '$or', function (doc, query) {
...
registry.registerOperator('pre', '$nor', function (doc, query) {
...
registry.registerOperator('pre', '$where', function (doc, query) {
