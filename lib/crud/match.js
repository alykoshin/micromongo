...
function _containsAllDeep(target, source, options) {
  ...
  return _contains(target, source, { all: true, ordered: options.ordered });
}
...
function _containsAnyDeep(target, source, options) {
  ...
  return _contains(target, source, { any: true, ordered: options.ordered });
}
...
var _eql = function(target, source, options) {
  ...
  return _containsAllDeep(target, source, { ordered: options.ordered }) && _containsAllDeep(source, target, { ordered: options.ordered });
};
