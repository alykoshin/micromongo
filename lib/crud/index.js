...
function doUpsert(array, query, update) {
...
var updateOne = function(array, query, update, options) {
  ...
  var report = { acknowledged: true, matchedCount: matchedCount, modifiedCount: modifiedCount };
...
var updateMany = function(array, query, update, options) {
  ...
  var report = { acknowledged: true, matchedCount: docs.length, modifiedCount: modifiedCount };
