...
var aggregateStageOps = {
  ...
  $unwind: function(array, params, options) {

    var _unwindDoc = function(doc) {
      var res = [];
    ...
    options = options || {};
    options.preserveNullAndEmptyArrays = typeof options.preserveNullAndEmptyArrays === 'undefined' ? false : options.preserveNullAndEmptyArrays;
    ...
    for (var len=array.length, i=0; i<len; ++i) {
      ...
      if (typeof value === 'undefined' || value === null) { // skip doc
        if (options.preserveNullAndEmptyArrays) { res.push(doc); }
