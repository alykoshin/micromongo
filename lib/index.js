...
var aggregateStageOps = {
  ...
  $project: function(array, params) {
    throw new Error('Not implemented');
  },

  $match: function(array, params) {
    throw new Error('Not implemented');
  },

  $redact: function(array, params) {
    throw new Error('Not implemented');
  },
  ...
  $skip: function(array, params) {
    if (typeof params !== 'number') { throw new TypeError('Number expected'); }
    return array.slice(params);
  },

  $unwind: function(array, params) {
    var p = _parseFieldPath(params);
    var res = [];

    for (var len1=array.length, i1=0; i1<len1; ++i1) {
      var doc = array[i1];
      var value = _.get(doc, p);

      if (typeof value === 'undefined') { // skip doc
        //array.splice(i1);
        ...
        //array.splice(i1); // remove element from result

        for (var len2=value.length, i2=0; i2<len2; ++i2) {
          var newDoc = deepAssign({}, doc);
          _.set(newDoc, p, value[i2]);
          res.push(newDoc);
        }
  ...
  $group: function(array, params) {
    throw new Error('Not implemented');
  },

  $sample: function(array, params) {
    throw new Error('Not implemented');
  },

  $sort: function(array, params) {
    throw new Error('Not implemented');
  },

  $geoNear: function(array, params) {
    throw new Error('Not implemented');
  },

  $lookup: function(array, params) {
    throw new Error('Not implemented');
  },

  $out: function(array, params) {
    throw new Error('Not implemented');
  },

  $indexStats: function(array, params) {
    throw new Error('Not implemented');
  },
...
var aggregate = function(array, stages) {
