...
function register(reg: any): void {
  ...
  reg.registerOperator('pre', '$text', function (doc: Document, query: any /* value (operand) */) {
  ...
  reg.registerOperator('pre', '$and', function (this: any, doc: Document, query: any /* values (sub-queries) */) {
  ...
  reg.registerOperator('pre', '$or', function (this: any, doc: Document, query: any /* values (sub-queries) */) {
  ...
  reg.registerOperator('pre', '$nor', function (this: any, doc: Document, query: any /* values (sub-queries) */) {
   ...
   */
  reg.registerOperator('pre', '$where', function (this: any, doc: Document, query: any /* value (string|function) */) {
