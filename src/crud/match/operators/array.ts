...
registry.registerOperator('post', '$all', function (doc: any, query: any) {
...
registry.registerOperator('post', '$elemMatch', function (this: any, doc: any, query: any) {
...
registry.registerOperator('post', '$size', function (doc: any, query: any) {
