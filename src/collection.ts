 ...
 * @constructor
 */
function Collection(this: any, array: any[], options: any) {
...
function indexName(fields: any) { return fields.join('_'); }

/** Normalize a createIndex argument to a {field:1,…} spec + field list. */
function normalizeSpec(spec: any) {
  if (typeof spec === 'string') { var s: any = {}; s[spec] = 1; return s; }
...
Collection.prototype._reindex = function (this: any) {
 ...
 * the linear scan.
 */
Collection.prototype.createIndex = function (this: any, spec: any) {
...
Collection.prototype.getIndexes = function (this: any) {
  return Object.keys(this._indexes);
};

/** Drop an index by field name or spec. Returns whether it existed. */
Collection.prototype.dropIndex = function (this: any, spec: any) {
 ...
 */
Collection.prototype._getIndexFor = function (this: any, fieldOrFields: any) {
 ...
 */
Collection.prototype._planQuery = function (this: any, query: any) {
  var self = this;
  return planner.plan(query, this._indexes, function (f: any) { return self._getIndexFor(f); });
};

// --- reads (pure; return deep copies) ---

Collection.prototype.count = function (this: any, query: any) {
 ...
 */
Collection.prototype.find = function (this: any, query: any, projection: any) {
  var plan = this._planQuery(query);
 ...
 */
Collection.prototype._makeSortProvider = function (this: any, query: any, plan: any) {
  var self = this;
...
Collection.prototype.findOne = function (this: any, query: any, projection: any) {
  var plan = this._planQuery(query);
  if (plan) {
    if (plan.exact) {
...
Collection.prototype.distinct = function (this: any, field: any, query: any) {
  return crud.distinct(this._data, field, query);
};

Collection.prototype.aggregate = function (this: any, stages: any, options: any) {
  options = options || {};
...
Collection.prototype.indexStats = function (this: any) {
  var out: any[] = [];
  for (var name in this._indexes) { if (this._indexes.hasOwnProperty(name)) {
    var idx = this._indexes[name];
...
function statName(idx: any) {
  return idx.fields.map(function (f: any) { return f + '_' + idx.spec[f]; }).join('_');
}
...
Collection.prototype._w = function (this: any, result: any) {
  if (this._hasIndexes()) { this._reindex(); }
  return result;
};
Collection.prototype._hasIndexes = function (this: any) {
  for (var k in this._indexes) { if (this._indexes.hasOwnProperty(k)) { return true; } }
  return false;
};

Collection.prototype.insertOne = function (this: any, doc: any, options: any) {
  return this._w(crud.insertOne(this._data, doc, options));
};

Collection.prototype.insertMany = function (this: any, docs: any, options: any) {
  return this._w(crud.insertMany(this._data, docs, options));
};

Collection.prototype.insert = function (this: any, docOrDocs: any, options: any) {
  return this._w(crud.insert(this._data, docOrDocs, options));
};

Collection.prototype.deleteOne = function (this: any, query: any) {
  return this._w(crud.deleteOne(this._data, query));
};

Collection.prototype.deleteMany = function (this: any, query: any) {
  return this._w(crud.deleteMany(this._data, query));
};

Collection.prototype.remove = function (this: any, query: any, options: any) {
  return this._w(crud.remove(this._data, query, options));
};

Collection.prototype.updateOne = function (this: any, query: any, update: any, options: any) {
  return this._w(crud.updateOne(this._data, query, update, options));
};

Collection.prototype.updateMany = function (this: any, query: any, update: any, options: any) {
  return this._w(crud.updateMany(this._data, query, update, options));
};

Collection.prototype.replaceOne = function (this: any, query: any, replacement: any, options: any) {
  return this._w(crud.replaceOne(this._data, query, replacement, options));
};

Collection.prototype.findOneAndUpdate = function (this: any, query: any, update: any, options: any) {
  return this._w(crud.findOneAndUpdate(this._data, query, update, options));
};

Collection.prototype.findOneAndReplace = function (this: any, query: any, replacement: any, options: any) {
  return this._w(crud.findOneAndReplace(this._data, query, replacement, options));
};

Collection.prototype.findOneAndDelete = function (this: any, query: any) {
...
Collection.prototype.reindex = function (this: any) {
  this._reindex();
  return this;
};
 ...
 * it as read access.
 */
Collection.prototype.toArray = function (this: any): any[] {
  return this._data;
};
