 ...
 *
 * Keyed by kind → operation name → { summary, notes?, returns?, partial?, extra? }:
 ...
 *
 * This file holds PROSE only. Executable EXAMPLES (fixture + operation + expected result) live in
 * the canonical set at meta/mongo-examples/ — one record drives the micromongo test, the live-Mongo
 * differential test, and the docs (see planning/unified-examples.md). Don't re-add an `example`
 * field here.
 *
